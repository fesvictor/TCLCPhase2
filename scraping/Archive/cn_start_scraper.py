...
for page_limit in range(1, page_limit+1):
    #THREAD LINK scraper
    print("[T] Link scraper initiated with page limit: " + str(page_limit))
    _titles, _links, _dates = t.tlink_scrape('http://www.jbtalks.cc/forum-674-%d.html' % (page_limit), 1)
    ...
    print("\t\t[P] Post scraper page %d completed" % page_limit)
